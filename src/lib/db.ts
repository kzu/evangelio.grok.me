...
export function ensureDbReady(): Promise<void> {
  ...
  // The Vercel/Nitro bundle does not include pglite.data; constructing PGLite
  // there crashes the process with an uncaught ENOENT. Dev (`vite dev`) still
  // uses the embedded DB. Deployed apps have DATABASE_URL so they never hit this.
